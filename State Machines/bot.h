...
class Bot : public BehaviourStates, public botLogic
{
protected:
...
public:
  ...
  void reload();
	...
	// State Functions
	void StateChange(State<Bot>* newState);
	void setAccel(Vector2D accel);
	int getAmmo();
	bool getFiring();
	...
	Vector2D getClosestEnemyLocation();
